...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="menu-content">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/"><img src="/front/images/logo.png" alt=""></a>
                    </div>
        ...
        <div id="footer">
            <div class="footer-instagram-section">
                ...
                <div id="footer-instagram" class="owl-carousel">
                    ...
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-1.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-2.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-3.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-4.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-5.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-6.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-7.jpg" alt=""></a>
                    </div>
                    <div class="item">
                        <a href="#"><img src="/front/images/ins-8.jpg" alt=""></a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <aside class="footer-widget">
                            <div class="about-img"><img src="/front/images/footer-logo.png" alt=""></div>
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <div class="single-review">
                                            ...
                                            <div class="author-id">
                                                <img src="/front/images/author.png" alt="">
                    ...
                    <div class="col-md-4">
                        <aside class="footer-widget">
                            ...
                            <div class="custom-post">
                                <div>
                                    <a href="#"><img src="/front/images/footer-img.png" alt=""></a>
                                </div>
                                <div>
        ...
        <script type="text/javascript" src="/front/js/jquery.stickit.min.js"></script>
