        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="top-comment"><!--top comment-->
                    <img src="/front/images/comment.jpg" class="pull-left img-circle" alt="">
                    <h4>Rubel Miah</h4>
                ...
                <div class="bottom-comment"><!--bottom comment-->
                    ...
                    <div class="comment-img">
                        <img class="img-circle" src="/front/images/comment-img.jpg" alt="">
                    </div>
